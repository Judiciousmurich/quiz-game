...
function loadQuestion() {
    ...
    question.options.forEach((option, index) => {
        ...
        if (question.checked && question.userAnswer !== null) {
            ...
            // Removed the code that shows the correct answer
        } 
...
function selectOption(e) {
    ...
    if (!question.checked) {
        ...
        // Update question indicators to show this question as answered
        updateQuestionIndicators();
...
function checkAnswer() {
    ...
    if (selectedIndex !== null) {
        ...
        if (selectedIndex === question.answer) {
            ...
            // Removed the code that highlights the correct answer
            feedbackText.textContent = "That's incorrect.";
        }
        ...
        if (timeLeft <= 0) {
            ...
            setTimeout(() => {
                if (currentQuestion < questions.length - 1) {
                    ...
                    // Don't auto-finish, just indicate that time is up for the last question
                    timerContainer.classList.add('hide');
